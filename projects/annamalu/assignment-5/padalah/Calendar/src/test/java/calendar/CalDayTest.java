...
public class CalDayTest {
	...
	public void test02() throws Throwable { //testing the addAppt method
		...
		startMonth = 02;
		startYear = 2017;
		title = "Testing event3";
		description = "This is my other testing event3.";

		Appt appt3 = new Appt(startHour, startMinute, startDay, startMonth, startYear, title, description); //another valid appt
		...
		assertEquals(35, calday.getAppts().get(1).getStartMinute());
		assertEquals(2017, calday.getAppts().get(1).getStartYear());
		assertEquals(4, calday.getSizeAppts()); //3 appts were added in total
	}
